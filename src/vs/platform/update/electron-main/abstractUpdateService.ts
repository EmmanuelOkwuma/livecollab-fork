...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often LiveCollab updates have failed.';
};
...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when LiveCollab detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of LiveCollab.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of LiveCollab.' };
