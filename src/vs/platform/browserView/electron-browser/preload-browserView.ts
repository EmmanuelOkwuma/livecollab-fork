...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* LiveCollab injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* LiveCollab injected style */ * { cursor: crosshair !important; }';
