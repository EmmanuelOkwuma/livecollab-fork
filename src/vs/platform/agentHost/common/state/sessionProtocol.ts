...
// This file adds LiveCollab-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * LiveCollab-specific extension: set the auth token on the server.
