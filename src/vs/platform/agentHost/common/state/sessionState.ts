...
// (synced from the agent-host-protocol repo). This file adds LiveCollab-specific
...
// ---- LiveCollab-specific derived types -----------------------------------------
...
/**
 * LiveCollab-side alias for the protocol's open `_meta` property bag on
 ...
 * {@link ISessionGitState}. This is a LiveCollab-specific convention layered
