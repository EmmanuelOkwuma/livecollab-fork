 ...
 * by the LiveCollab CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the LiveCollab CLI populate this
 ...
 * extension used by LiveCollab-hosted agent hosts.
 *
