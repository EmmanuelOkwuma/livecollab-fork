...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a LiveCollab CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * LiveCollab Remote SSH authority.
	 */
	 ...
	 * client connects to, and is used to construct the LiveCollab Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the LiveCollab Remote Tunnels authority
