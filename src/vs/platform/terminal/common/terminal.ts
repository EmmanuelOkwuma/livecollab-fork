...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit LiveCollab's "shell environment" that may
	 ...
	 * a terminal used to drive some LiveCollab feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to LiveCollab and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** LiveCollab shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
