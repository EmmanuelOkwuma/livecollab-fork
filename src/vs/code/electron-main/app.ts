...
/**
 * The main LiveCollab application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting LiveCollab');
		...
		// "com.microsoft.", which breaks native tabs for LiveCollab when using this
