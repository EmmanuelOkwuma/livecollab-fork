...
export class DefaultExtensionsInitializer extends Disposable {
	...
	private getDefaultExtensionVSIXsLocation(): URI {
		if (this.productService.win32VersionedUpdate) {
			// appRoot = C:\Users\<name>\AppData\Local\Programs\Microsoft LiveCollab Insiders\<version>\resources\app
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft LiveCollab Insiders\<version>\bootstrap\extensions
			return URI.file(join(dirname(dirname(dirname(this.environmentService.appRoot))), 'bootstrap', 'extensions'));
		} else {
			// appRoot = C:\Users\<name>\AppData\Local\Programs\Microsoft LiveCollab Insiders\resources\app
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft LiveCollab Insiders\bootstrap\extensions
