...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in LiveCollab in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open LiveCollab and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
