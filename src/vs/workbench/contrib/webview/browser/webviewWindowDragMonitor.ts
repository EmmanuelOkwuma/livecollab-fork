...
/**
 * Allows webviews to monitor when an element in the LiveCollab editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. LiveCollab needs to see this
