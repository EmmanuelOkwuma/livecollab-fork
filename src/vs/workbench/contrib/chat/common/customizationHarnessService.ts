 ...
 *
 * The default (core) registration exposes a single "LiveCollab" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * LiveCollab harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default LiveCollab harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "LiveCollab" harness descriptor that shows all storage sources
