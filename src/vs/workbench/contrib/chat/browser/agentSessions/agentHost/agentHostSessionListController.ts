...
export class AgentHostSessionListController extends Disposable implements IChatSessionItemController {
	...
	constructor(
		...
		// Re-fetch the session list whenever the set of LiveCollab workspace
		// folders changes, since filtering depends on it. The agent host
		// itself doesn't know which workspace this LiveCollab window has open,
	 ...
	 * to the current LiveCollab workspace. When the window has no workspace
	 * folders open (e.g. the Agents window, or an empty LiveCollab window),
