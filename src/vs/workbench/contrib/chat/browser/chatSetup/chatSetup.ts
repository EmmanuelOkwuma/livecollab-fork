...
/**
 * Builds a redirect URL that GitHub will use to return the user to LiveCollab
 ...
 * @param urlProtocol The LiveCollab URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
