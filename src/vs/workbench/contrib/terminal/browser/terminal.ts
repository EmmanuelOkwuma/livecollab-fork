 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in LiveCollab UI).
 */
 ...
 * to represent terminals that appear in other parts of the LiveCollab UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their LiveCollab OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given LiveCollab log level.
	 */
	updateLogLevel(): void;
