...
export const InAutomationContext = new RawContextKey<boolean>('inAutomation', false, localize('inAutomation', "Whether LiveCollab is running under automation/smoke test"));
