...
export class WorkspacePicker extends Disposable {
	...
	/** Cached LiveCollab recent folder URIs, resolved lazily. */
	...
	constructor(
		...
		// Load LiveCollab recent folders eagerly and refresh on changes
	 ...
	 * without source grouping. Own recents come first, followed by LiveCollab
	 * recent folders.
	 */
	protected _buildItems(): IActionListItem<IWorkspacePickerItem>[] {
		...
		// Merge LiveCollab recent folders (resolved through providers, deduplicated)
	...
	/**
	 * Returns LiveCollab recent folders resolved through registered session
