...
/** Local session type — in-process LiveCollab chat, no background agent or worktree. */
...
/** Setting key controlling whether Local LiveCollab chat sessions are available in the Agents app. */
