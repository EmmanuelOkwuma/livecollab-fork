...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	...
	properties: {
		[LOCAL_SESSION_ENABLED_SETTING]: {
			...
			description: localize('sessions.chat.localAgent.enabled', "Enable Local LiveCollab chat sessions in the Agents Window. Reload the window for changes to take effect."),
		},
	},
});
