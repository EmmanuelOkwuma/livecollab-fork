...
/**
 * LiveCollab logo "fish" used by the Agents window aquarium. Each fish is a small
...
/** The three LiveCollab release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the LiveCollab logo path. All fish reference
 ...
 *   - LiveCollab logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original LiveCollab icon.
